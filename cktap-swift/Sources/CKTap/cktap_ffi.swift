...
public struct SatsCardStatus: Equatable, Hashable {
    ...
    public init(proto: UInt32, ver: String, birth: UInt32, activeSlot: UInt8, numSlots: UInt8, addr: String?, pubkey: String, cardIdent: String, authDelay: UInt8?) {
        self.proto = proto
        self.ver = ver
        self.birth = birth
...
public struct FfiConverterTypeSatsCardStatus: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SatsCardStatus, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt32.write(value.birth, into: &buf)
...
public struct SatsChipStatus: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(proto: UInt32, ver: String, birth: UInt32, path: [UInt32]?, pubkey: String, cardIdent: String, authDelay: UInt8?) {
        self.proto = proto
        self.ver = ver
        self.birth = birth
        self.path = path
...
public struct FfiConverterTypeSatsChipStatus: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SatsChipStatus, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.ver, into: &buf)
        FfiConverterUInt32.write(value.birth, into: &buf)
        FfiConverterOptionSequenceUInt32.write(value.path, into: &buf)
        FfiConverterString.write(value.pubkey, into: &buf)
        FfiConverterString.write(value.cardIdent, into: &buf)
        FfiConverterOptionUInt8.write(value.authDelay, into: &buf)
    }
...
public struct TapSignerStatus: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(proto: UInt32, ver: String, birth: UInt32, path: [UInt32]?, numBackups: UInt32, pubkey: String, cardIdent: String, authDelay: UInt8?) {
        self.proto = proto
        self.ver = ver
        self.birth = birth
        self.path = path
...
public struct FfiConverterTypeTapSignerStatus: FfiConverterRustBuffer {
    ...
    public static func write(_ value: TapSignerStatus, into buf: inout [UInt8]) {
        ...
        FfiConverterUInt32.write(value.birth, into: &buf)
        FfiConverterOptionSequenceUInt32.write(value.path, into: &buf)
        FfiConverterUInt32.write(value.numBackups, into: &buf)
        FfiConverterString.write(value.pubkey, into: &buf)
        FfiConverterString.write(value.cardIdent, into: &buf)
        FfiConverterOptionUInt8.write(value.authDelay, into: &buf)
    }
...
enum ChangeError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case SameAsOld
    case CurrentCvc(err: CvcError
    )
    case NewCvc(err: CvcError
    )
...
public struct FfiConverterTypeChangeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ChangeError {
        ...
        case 3: return .CurrentCvc(
            err: try FfiConverterTypeCvcError.read(from: &buf)
            )
        case 4: return .NewCvc(
            err: try FfiConverterTypeCvcError.read(from: &buf)
            )
...
enum CkTapError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case UnknownErrorCode(code: UInt16, message: String
    )
...
public struct FfiConverterTypeCkTapError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CkTapError {
        ...
        case 5: return .UnknownErrorCode(
    ...
    public static func write(_ value: CkTapError, into buf: inout [UInt8]) {
        ...
        case let .UnknownErrorCode(code,message):
            writeInt(&buf, Int32(5))
 ...
 */
public 
enum CvcError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {

    
    
    case TooShort(length: UInt32
    )
    case TooLong(length: UInt32
    )
    case NonAsciiDigit(index: UInt32
    )
...
#if compiler(>=6)
extension CvcError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCvcError: FfiConverterRustBuffer {
    typealias SwiftType = CvcError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CvcError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: CvcError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCvcError_lift(_ buf: RustBuffer) throws -> CvcError {
    return try FfiConverterTypeCvcError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
@Sendable public func FfiConverterTypeCvcError_lower(_ value: CvcError) -> RustBuffer {
    return FfiConverterTypeCvcError.lower(value)
}
...
@_documentation(visibility: private)
#endif
@Sendable public func FfiConverterTypeInitError_lower(_ value: InitError) -> RustBuffer {
...
enum SignPsbtError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case MissingPubkey(index: UInt32
    )
    case MissingUtxo(index: UInt32
    )
    case PubkeyMismatch(index: UInt32
    )
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_cktap_ffi_checksum_method_satschip_init() != 42524) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cktap_ffi_checksum_method_tapsigner_init() != 26344) {
        return InitializationResult.apiChecksumMismatch
    }
